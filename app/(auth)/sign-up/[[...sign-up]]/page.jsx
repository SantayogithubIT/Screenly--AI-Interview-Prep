             ...
             <div className="flex-col flex self-center lg:px-14 sm:max-w-4xl xl:max-w-md z-10">
              <img className='transition-transform hover:scale-105' src="/logo.svg" alt="" />
               <div className="self-start hidden lg:flex flex-col text-gray-300">
                 <h1 className="my-3 font-semibold text-4xl">Join Screenly — your interview prep buddy.</h1>
                 <p className='pr-3 text-sm opacity-75'>
                 Practice real interview questions with AI.
Get instant feedback, track progress, and build confidence.
                 </p>
               </div>
             </div>
           ...
           >
             <path
               fill="#ffffff"
               fillOpacity="1"
               d="M0,0L40,42.7C80,85,160,171,240,197.3C320,224,400,190,480,154.7C560,117,640,75,720,74.7C800,75,880,117,960,154.7C1040,192,1120,224,1200,213.3C1280,203,1360,149,1400,122.7L1440,96L1440,320L0,320Z"
             ></path>
           </svg>
         </div>
